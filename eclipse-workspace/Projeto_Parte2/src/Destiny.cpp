...
Destiny::Destiny(std::string cityName, std::vector<Accommodation*> accommodation, std::vector<PossibleDestinies*> destinies, Coordinates *coordinates){
	this->ID = ultID++;
	this->cityName = cityName;
	this->accommodation = accommodation;
	this->destinies = destinies;
...
Destiny::Destiny(std::string cityName, std::vector<Accommodation*> accommodation, std::vector<PossibleDestinies*> destinies, Coordinates *coordinates, std::vector<std::string> interestPoints){
	this->ID = ultID++;
	this->cityName = cityName;
	this->accommodation = accommodation;
	this->destinies = destinies;
...
std::vector<std::string> Destiny::getInterestPoints(){
