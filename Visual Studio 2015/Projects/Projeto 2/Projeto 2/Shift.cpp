...
Shift::Shift(  unsigned int line, unsigned int driver, unsigned int bus, unsigned int begining, unsigned int end){
	this->busLineId = line;
	this->driverId = driver;
	this->busOrderNumber = bus;
	this->startTime = begining;
	this->endTime = end;
}
